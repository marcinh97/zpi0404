    ...
    render() {
        return (
            <div >
                ...
                <div id="formPhoto">
                    <div id="formDiv">
                        <h3 id="hstylee" className="login-heading mb-4">Witaj ponownie!</h3>
                        <form method="post" onSubmit={this.kot}>
                            ...
                            <div className="text-center">
                                ...
                                <Nav.Link id="hstylee" onClick={this.setRedirectRegister}>Nie masz konta? Zarejstruj się tutaj </Nav.Link>
                            </div>
                        </form>
                    </div>
                </div>
